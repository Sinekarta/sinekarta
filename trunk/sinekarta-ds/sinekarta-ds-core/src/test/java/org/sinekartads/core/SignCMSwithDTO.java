...
//
//public class SignCMSwithDTO extends SinekartaDsTestCase {
//
...
//
//	static final Logger tracer = Logger.getLogger(SignCMSwithDTO.class);
...
//		try {
//			dto = converter.fromSignatureInfo ( (SignatureInfo < SignCategory, SignDisposition.CMS, 
//															     VerifyResult, CMSSignatureInfo >) chainSignature );
//		} catch(Exception e) {
...
//		try {
//			digestSignature = (DigestSignature < SignCategory, SignDisposition.CMS, 
//				     VerifyResult, CMSSignatureInfo >) converter.toSignatureInfo(dto);
//		} catch(Exception e) {
...
//		try {
//			dto = converter.fromSignatureInfo ( (SignatureInfo < SignCategory, SignDisposition.CMS, 
//															  	 VerifyResult, CMSSignatureInfo >) signedSignature );
//		} catch(Exception e) {
...
//		try {
//			finalizedSignature = (FinalizedSignature < SignCategory, SignDisposition.CMS, 
//				     VerifyResult, CMSSignatureInfo >) converter.toSignatureInfo ( dto );
//		} catch(Exception e) {
//			tracer.error("unable to obtain the digestSignature from the DTO", e);
//			throw e;
