...
/**
 * This class has been edited by JENIA Software in order to allow the direct 
 * instance generation, see the PdfSignatureAppearance(PdfStamper stamper)
...
public class PdfSignatureAppearance {
     ...
     * @param stamper	the stamper to which the signature will be written.
     */
    public PdfSignatureAppearance(PdfStamper stamper) {
