...
public class PKCS11InitializationException extends SmartCardAccessException {

	private static final long serialVersionUID = 1L;

	public PKCS11InitializationException() {
	}
	...
	public PKCS11InitializationException(String message) {
		super(message);
	}

	public PKCS11InitializationException(Throwable cause) {
		super(cause);
	}
