...
public class SignXMLonAlfresco extends BaseIntegrationTC {
	
	static final DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
	
	static Logger tracer = Logger.getLogger(SignXMLonAlfresco.class);
	
	private static final String SOURCE_REF 		= "workspace://SpacesStore/cd3fd323-45f1-4aa4-a9ed-57915ae6e148"; 
...
//		
//		String descrizioneMotivoFirma = "questo testo � la descrizione del motivo di firma che viene inserito nel documento XML";
//		
//		String localitaFirma = "Italy"; // localit� in cui � apposta la firma (anche questo dato viene inserito nel documento XML
//		
//		String digitalSignatureArea = null; // l' handle
//		
//		{ // step 1 : conversione in XML/A
...
//	        localcontext.setAttribute(ClientContext.AUTH_CACHE, authCache);
//	
//	        HttpPost httppost = new HttpPost(DOCUMENT_TO_XMLA);
//	
//	        // prima di tutto, il documento va convertito in XML/A
...
//		// se il documento fosse gi� stato un XML/A, non sarebbe stato necessario convertirlo
...
//	        // la procedura lasciata a met� non modifica i documenti XML precedentemente creati
//	        String req = "{" +
//	        				"\"digitalSignatureArea\" : \""+digitalSignatureArea+"\", " +
