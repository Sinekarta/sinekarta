...
public class DefaultTimeStampTokenProvider implements TimeStampTokenProvider
{
    ...
    static
    {
        ...
        digestUriToOidMappings.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_NOT_RECOMMENDED_MD5, new ASN1ObjectIdentifier(TSPAlgorithms.MD5));
        digestUriToOidMappings.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_RIPEMD160, new ASN1ObjectIdentifier(TSPAlgorithms.RIPEMD160));
        digestUriToOidMappings.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA1, new ASN1ObjectIdentifier(TSPAlgorithms.SHA1));
        digestUriToOidMappings.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA256, new ASN1ObjectIdentifier(TSPAlgorithms.SHA256));
        digestUriToOidMappings.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA384, new ASN1ObjectIdentifier(TSPAlgorithms.SHA384));
        digestUriToOidMappings.put(MessageDigestAlgorithm.ALGO_ID_DIGEST_SHA512, new ASN1ObjectIdentifier(TSPAlgorithms.SHA512));
    }
